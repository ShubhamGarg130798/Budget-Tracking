...
st.markdown("<br><br>", unsafe_allow_html=True)
st.markdown("---")
footer_html = "<div style='text-align: center; color: #666; font-size: 0.9rem;'><strong>Brand Expense Tracker v2.0</strong> | Multi-Stage Approval System<br>HR Entry - Brand Head Approval - Senior Manager Approval - Accounts Payment</div>"
st.markdown(footer_html, unsafe_allow_html=True) col1:
